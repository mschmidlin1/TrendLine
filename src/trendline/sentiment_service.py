...
class SentimentService(metaclass=SingletonMeta):
    ...
    def analyze_sentiment(self, text: str, article_id: str) -> None:
        ...
        Args:
            ...
            article_id (str): Article id to attach the sentiment rows to.
        """
    ...
    def _parse_sentiment(self, response: str, article_id: str) -> bool:
        """
        Parse the raw LLM response and insert one sentiments row per ticker.
        ...
        Returns:
            bool: True when the response was stored, False when it was rejected.
        """
